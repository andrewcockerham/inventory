...
class BuildsControllerTest < ActionController::TestCase
  ...
  test "should create build" do
    assert_difference('Build.count') do
      post :create, build: { start_date: @build.start_date, start_qty: @build.start_qty, yield_qty: @build.yield_qty }
    end
  ...
  test "should update build" do
    patch :update, id: @build, build: { start_date: @build.start_date, start_qty: @build.start_qty, yield_qty: @build.yield_qty }
    assert_redirected_to build_path(assigns(:build))
  end
