...
class PurchaseOrdersControllerTest < ActionController::TestCase
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post :create, purchase_order: { Date: @purchase_order.Date, purchase_order_number: @purchase_order.purchase_order_number }
    end
  ...
  test "should update purchase_order" do
    patch :update, id: @purchase_order, purchase_order: { Date: @purchase_order.Date, purchase_order_number: @purchase_order.purchase_order_number }
    assert_redirected_to purchase_order_path(assigns(:purchase_order))
  end
